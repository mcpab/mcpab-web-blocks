...
var muiTheme = require('@mcpab/mui-theme');
var colors = require('@mui/material/colors');

// src/quantumMathMusicPaperPreset.ts
var quantumMathMusicPaperPreset = {
  palette: {
    mode: "light",
    primary: { main: "#1E3A8A", contrastText: "#FFFFFF" },
    secondary: { main: "#C026D3", contrastText: "#FFFFFF" },
    info: { main: "#06B6D4", contrastText: "#002b36" },
    text: { primary: colors.blueGrey[900], secondary: colors.blueGrey[700], disabled: colors.blueGrey[300] },
    background: { default: "#FFFFFF", paper: "#FFFFFF" },
    divider: colors.blueGrey[100],
    contrastThreshold: 3,
    tonalOffset: 0.08
  },
  ...
  typography: {
    ...
    fontWeightBold: 700,
    body1: muiTheme.generateTypographyVariant({
      fontSize: "1.0rem",
      fontWeight: 400,
    ...
    body2: muiTheme.generateTypographyVariant({
      fontSize: "0.9375rem",
      fontWeight: 400,
      letterSpacing: "0.005em",
      lineHeight: 1.7
    ...
    lead: muiTheme.generateTypographyVariant({
      fontSize: "1.125rem",
      fontWeight: 400,
    ...
    narrative: muiTheme.generateTypographyVariant({
      fontSize: "1.0rem",
      fontWeight: 400,
      letterSpacing: "0.005em",
      lineHeight: 1.8,
    ...
    strapline: muiTheme.generateTypographyVariant({
      fontSize: "0.9375rem",
      fontWeight: 400,
    ...
    eyebrow: muiTheme.generateTypographyVariant({
      fontSize: "0.75rem",
      fontWeight: 600,
      letterSpacing: "0.14em",
      lineHeight: 1.35
    }),
    finePrint: muiTheme.generateTypographyVariant({
      fontSize: "0.8125rem",
      fontWeight: 400,
      letterSpacing: "0.015em",
      lineHeight: 1.6
    }),
    quote: muiTheme.generateTypographyVariant({
      fontSize: "1.0625rem",
      fontWeight: 400,
      letterSpacing: "0.002em",
      lineHeight: 1.95,
    ...
    h1: muiTheme.generateTypographyVariant({
      fontSize: "2.4rem",
      fontWeight: 700,
      letterSpacing: "-0.015em",
      lineHeight: 1.12,
    ...
    h2: muiTheme.generateTypographyVariant({
      fontSize: "1.95rem",
      fontWeight: 700,
    ...
    h3: muiTheme.generateTypographyVariant({
      fontSize: "1.55rem",
      fontWeight: 700,
      lineHeight: 1.22,
      breakpoints: { sm: "1.75rem", md: "1.95rem" }
    }),
    h4: muiTheme.generateTypographyVariant({
      fontSize: "1.3rem",
      fontWeight: 700,
      lineHeight: 1.25,
      breakpoints: { sm: "1.45rem", md: "1.6rem" }
    }),
    h5: muiTheme.generateTypographyVariant({
      fontSize: "1.125rem",
      fontWeight: 700,
      lineHeight: 1.3,
      breakpoints: { sm: "1.25rem" }
    }),
    h6: muiTheme.generateTypographyVariant({
      fontSize: "1.0rem",
      fontWeight: 700,
      lineHeight: 1.35,
      breakpoints: { sm: "1.125rem" }
    ...
    subtitle1: muiTheme.generateTypographyVariant({
      fontSize: "0.95rem",
      fontWeight: 400,
      letterSpacing: "0.01em",
      lineHeight: 1.5
    }),
    subtitle2: muiTheme.generateTypographyVariant({
      fontSize: "0.875rem",
      fontWeight: 600,
      letterSpacing: "0.01em",
      lineHeight: 1.45
    }),
    button: muiTheme.generateTypographyVariant({
      fontSize: "0.9rem",
      fontWeight: 600,
      letterSpacing: "0.03em",
      lineHeight: 1.3
    }),
    caption: muiTheme.generateTypographyVariant({
      fontSize: "0.75rem",
      fontWeight: 400,
      letterSpacing: "0.02em",
      lineHeight: 1.4
    }),
    overline: muiTheme.generateTypographyVariant({
      fontSize: "0.75rem",
      fontWeight: 600,
      letterSpacing: "0.14em",
      lineHeight: 1.35
      ...
      variants: [
        ...
        { props: { variant: "quote" }, style: { maxWidth: "64ch", fontStyle: "italic" } },
        {
          ...
          style: ({ theme }) => ({
            ...
            fontWeight: 700,
            fontFamily: "var(--font-ui), Inter, ui-sans-serif, system-ui, -apple-system, 'Segoe UI', Roboto, Arial, sans-serif"
          })
        }
      ],
      styleOverrides: {
...
exports.quantumMathMusicPaperPreset = quantumMathMusicPaperPreset;
