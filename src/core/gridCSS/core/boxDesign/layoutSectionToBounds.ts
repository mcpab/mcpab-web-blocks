...
import { LayoutSectionBounds, LayoutSectionLocal, LocalGridBoxes } from "../boxLayout/boxLayoutTypes";
...
export function layoutSectionToBounds<sectionIDs extends SectionIDs, blockIDs extends BlocksIDs>(
    ...
    BREAKPOINTS.forEach(bp => {
        ...
        for (const sectionId in layoutSectionLocal.sections) {
            ...
            let gridBoxes: LocalGridBoxes<blockIDs> = layoutSectionLocal.sections[sectionId as sectionIDs];

            const boxesAtBp = gridBoxes.gridBoxes[bp];
            ...
            if (!boxesAtBp) {
                ...
                layoutSectionBounds.boundingBoxes[bp][sectionId as sectionIDs] = boundPerSection;
                continue;
            }
